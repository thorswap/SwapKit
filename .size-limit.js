module.exports = [
  ...
  { path: './packages/toolboxes/toolbox-cosmos/dist/index.cjs', name: 'toolbox-cosmos(cjs)', limit: '1.5 MB', },
  { path: './packages/toolboxes/toolbox-cosmos/dist/index.es.js', name: 'toolbox-cosmos(esm)', limit: '1.5 MB', },
  ...
  { path: './packages/wallets/evm-web3-wallets/dist/index.cjs', name: 'web3-wallets(cjs)', limit: '500 KB' },
  { path: './packages/wallets/evm-web3-wallets/dist/index.es.js', name: 'web3-wallets(esm)', limit: '500 KB' },
  ...
  { path: './packages/wallets/ledger/dist/index.cjs', name: 'ledger(cjs)', limit: '1.6 MB' },
  { path: './packages/wallets/ledger/dist/index.es.js', name: 'ledger(esm)', limit: '1.7 MB' },
  ...
  { path: './packages/wallets/xdefi/dist/index.cjs', name: 'xdefi(cjs)', limit: '500 KB' },
  { path: './packages/wallets/xdefi/dist/index.es.js', name: 'xdefi(esm)', limit: '500 KB' },
];
