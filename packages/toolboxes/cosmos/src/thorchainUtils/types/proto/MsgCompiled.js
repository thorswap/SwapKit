...
// Common aliases
var $Reader = minimal_js_1.default.Reader;
var $Writer = minimal_js_1.default.Writer;
var $util = minimal_js_1.default.util;
// Exported root namespace
var $root = (minimal_js_1.default.roots['default'] || (minimal_js_1.default.roots['default'] = {}));
$root.common = (function () {
    ...
    common.Asset = (function () {
        ...
        Asset.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, minimal_js_1.default.util.toJSONOptions);
        };
        return Asset;
    })();
    ...
    common.Tx = (function () {
        ...
        Tx.encode = function encode(message, writer) {
            ...
            if ((_b = message.gas) === null || _b === void 0 ? void 0 : _b.length)
                // eslint-disable-next-line @typescript-eslint/prefer-for-of
                for (var j = 0; j < message.gas.length; ++j)
                    $root.common.Coin.encode(message.gas[j], writer.uint32(/* id 6, wireType 2 =*/ 50).fork()).ldelim();
        ...
        Tx.verify = function verify(message) {
            ...
            if (message.gas != null && message.hasOwnProperty('gas')) {
                ...
                // eslint-disable-next-line @typescript-eslint/prefer-for-of
                for (var j = 0; j < message.gas.length; ++j) {
                    var error = $root.common.Coin.verify(message.gas[j]);
                    if (error)
                        return 'gas.' + error;
                }
            }
    ...
    types.MsgSend = (function () {
        ...
        MsgSend.verify = function verify(message) {
            if (typeof message !== 'object' || message === null)
                return 'object expected';
            if (message.fromAddress != null && message.hasOwnProperty('fromAddress'))
                if (!((message.fromAddress && typeof message.fromAddress.length === 'number') ||
                    $util.isString(message.fromAddress)))
                    return 'fromAddress: buffer expected';
            if (message.toAddress != null && message.hasOwnProperty('toAddress'))
                if (!((message.toAddress && typeof message.toAddress.length === 'number') ||
