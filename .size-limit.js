module.exports = [
  { path: './packages/wallets/evm-web3-wallets/dist/index.cjs', name: 'evm-web3-wallets(cjs)', limit: '5 KB' },
  { path: './packages/wallets/evm-web3-wallets/dist/index.es.js', name: 'evm-web3-wallets(esm)', limit: '5 KB' },
  ...
  { path: './packages/swapkit/swapkit-api/dist/index.cjs', name: 'swapkit-api(cjs)', limit: '5 KB' },
  { path: './packages/swapkit/swapkit-api/dist/index.es.js', name: 'swapkit-api(esm)', limit: '5 KB' },
  { path: './packages/swapkit/swapkit-core/dist/index.cjs', name: 'swapkit-core(cjs)', limit: '50 KB' },
  { path: './packages/swapkit/swapkit-core/dist/index.es.js', name: 'swapkit-core(esm)', limit: '50 KB' },
  { path: './packages/swapkit/swapkit-entities/dist/index.cjs', name: 'swapkit-entities(cjs)', limit: '10 KB' },
  { path: './packages/swapkit/swapkit-entities/dist/index.es.js', name: 'swapkit-entities(esm)', limit: '10 KB' },
  { path: './packages/swapkit/swapkit-explorers/dist/index.cjs', name: 'swapkit-explorers(cjs)', limit: '2 KB' },
  { path: './packages/swapkit/swapkit-explorers/dist/index.es.js', name: 'swapkit-explorers(esm)', limit: '2 KB' },
  ...
  { path: './packages/wallets/types/dist/index.cjs', name: 'types(cjs)', limit: '10 KB' },
  { path: './packages/wallets/types/dist/index.es.js', name: 'types(esm)', limit: '10 KB' },
