...
async function signSendChunkv1(app: any, chunkIdx: any, chunkNum: any, chunk: any) {
...
export function serializePathv2(path: any) {
...
export async function signSendChunkv2(app: any, chunkIdx: any, chunkNum: any, chunk: any) {
...
export async function publicKeyv2(app: any, data: any) {
  return app.transport
