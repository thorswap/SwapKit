export const list = {
  ...
  keywords: ["Native"],
  tokens: [
    { chain: "ARB", identifier: "ARB.ETH", decimals: 18, shortCode: "a" },
    { chain: "BTC", identifier: "BTC.BTC", decimals: 8, shortCode: "b" },
    { chain: "DASH", identifier: "DASH.DASH", decimals: 8, shortCode: "d" },
    { chain: "ETH", identifier: "ETH.ETH", decimals: 18, shortCode: "e" },
    { chain: "KUJI", identifier: "KUJI.KUJI", decimals: 6, shortCode: "k" },
    { chain: "KUJI", identifier: "KUJI.USK", decimals: 6, shortCode: "ku" },
    { chain: "KUJI", identifier: "KUJI.YUM", decimals: 6 },
    { chain: "THOR", identifier: "THOR.RUNE", decimals: 8, shortCode: "r" },
    {
      chain: "ETH",
