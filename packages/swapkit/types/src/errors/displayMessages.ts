...
export const ERROR_DISPLAY_MESSAGES: Record<string, string> = {
  ...
  [ERROR_CODE.SOURCE_ADDRESS_SCREENING_FAILED]: 'We are unable to serve quotes from this address {0}',
  [ERROR_CODE.DESTINATION_ADDRESS_SCREENING_FAILED]: 'We are unable to serve quotes from this address {0}',
