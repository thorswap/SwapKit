module.exports = [
  ...
  { path: './packages/swapkit/swapkit-sdk/dist/index.cjs', name: 'swapkit-sdk(cjs)', limit: '10 MB' },
  { path: './packages/swapkit/swapkit-sdk/dist/index.es.js', name: 'swapkit-sdk(esm)', limit: '10 MB' },
  ...
  { path: './packages/wallets/trezor/dist/index.cjs', name: 'trezor(cjs)', limit: '550 KB' },
  { path: './packages/wallets/trezor/dist/index.es.js', name: 'trezor(esm)', limit: '600 KB' },
